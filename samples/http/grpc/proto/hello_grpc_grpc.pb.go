...
type UserProviderClient interface {
	...
	SayHello(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error)
}
...
func (c *userProviderClient) SayHello(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
	err := c.cc.Invoke(ctx, "/provider.UserProvider/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserProviderServer interface {
	...
	SayHello(context.Context, *GetUserRequest) (*GetUserResponse, error)
...
func (UnimplementedUserProviderServer) SayHello(context.Context, *GetUserRequest) (*GetUserResponse, error) {
...
func _UserProvider_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserProviderServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provider.UserProvider/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserProviderServer).SayHello(ctx, req.(*GetUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
